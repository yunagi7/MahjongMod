...
public final class ModBlocks {
	...
	// MJ
	public static final RegistryObject<Block> M1_BLOCK = BLOCKS.register("m_1_block", () -> new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 3.0F)));
	public static final RegistryObject<Block> S1_BLOCK = BLOCKS.register("s_1_block", () -> new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 3.0F)));
	public static final RegistryObject<Block> P1_BLOCK = BLOCKS.register("p_1_block", () -> new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 3.0F)));
}
